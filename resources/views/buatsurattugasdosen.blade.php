  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <form action="/surattugasdosen" method="post">
        @csrf
        <div class="form-group">
            ...
            <div class="form-group">
                <label for="lokasikegiatan">Tujuan Surat</label>
                <input type="text" class="form-control" name="tujuansurat" placeholder="Masukkan Tujuan surat">
            </div>
            
            <div class="form-group">
                <label for="lokasikegiatan">Nama Mitra</label>
                <input type="text" class="form-control" name="namamitra" placeholder="Masukkan Mitra">
            </div>
            <div class="form-group">
                <label for="tgl">Tanggal pelaksanaan kegiatan</label>
                <input type="date" class="form-control" name="Tanggalpelaksanaan">
            </div>
            <div class="form-group">
