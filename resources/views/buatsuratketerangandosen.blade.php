  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/dashdosen" class="nav-link">Buat Surat</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/profiledosen" class="d-block">DSN-Orlando Sinaga</a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <form action="/suratketerangandosen" method="post">
        @csrf
        <div class="form-group">
                <label for="lokasikegiatan">NIK</label>
                <input type="text" class="form-control" name="nik" placeholder="Masukkan nik">
            </div>
            <div class="form-group">
                <label for="lokasikegiatan">Program Studi</label>
                <input type="text" class="form-control" name="jurusan" placeholder="Masukkan Mitra">
            </div>
            <div class="form-group">
                <label for="lokasikegiatan">Fakultas</label>
                <input type="text" class="form-control" name="fakultas" placeholder="Masukkan Mitra">
            </div>
            <div class="form-group">
                <label for="lokasikegiatan">Alamat</label>
                <input type="text" class="form-control" name="alamat" placeholder="Masukkan lokasi kegiatan">
            <div class="form-group">
