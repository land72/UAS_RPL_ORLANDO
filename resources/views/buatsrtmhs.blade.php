...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/dashmhs" class="nav-link">Buat Surat</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/dashmhs" class="brand-link">
      <img src="{{ asset('') }}assets/dist/img/fti.png" alt="MailPlus FTI Login" class="brand-image" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/profile" class="d-block">MHS-Christoper Dori</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
              <a href="/dashmhs/notification" class="nav-link">
            ...
            <li class="nav-item">
              <a href="/dashmhs/buatsrtmhs" class="nav-link">
            ...
            <li class="nav-item menu-close">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="/smmhs" class="nav-link ml-3">
                    <i class="far fa-envelope nav-icon"></i>
                    <p>Surat Masuk</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="/skmhs" class="nav-link ml-3">
            ...
            <li class="nav-item">
              <a href="/arsipmhs" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Buat Surat Tugas dan DP3</h1>
          </div>
        </div>
        <form action="/suratcreate" method="post">
            @csrf
            </div>
            <div class="form-group">
                <label for="tujuansurat">Tujuan Surat</label>
                <input type="date" class="form-control" name="tujuansurat" placeholder="Masukkan tujuan surat">
            </div>
            <div class="form-group">
                <label for="tgl">Tanggal pelaksanaan kegiatan</label>
                <input type="text" class="form-control" name="Tanggalpelaksa" placeholder="Tanggal pelaksanaan kegiatan">
            </div>
            <div class="form-group">
                <label for="nmmitra">Nama Mitra</label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="alamatmitra" placeholder="Masukkan alamat mitra">
            </div>
            <div class="form-group">
                <label for="keterangan">Keterangan</label>
                <textarea class="form-control" name="keterangan" id="txtKet" rows="3" placeholder="Masukkan Keterangan"></textarea>
            </div>
            <button class="btn btn-lg btn-primary btn-success text-dark" type="submit" value="Simpan">Kirim</button>
        </form>
