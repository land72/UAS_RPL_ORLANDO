  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/dashadmin/buatsrtadmin" class="nav-link">Buat Surat</a>
      </li>
    </ul>
      ...
      <div class="container-fluid">
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
            <div class="form-group">
                <label for="nmdekan">Nama Dekan</label>
                <input type="text" class="form-control" name="lokasi" placeholder="Masukkan Nama Dekan">
            </div>
            <div class="form-group">
                <label for="tglkeg">Tanggal</label>
                <input type="date" class="form-control" name="tgl">
            </div>
            <div class="form-group">
                <label for="keterangan">Keterangan</label>
                <textarea class="form-control" id="txtKet" rows="3" placeholder="Masukkan Keterangan"></textarea>
            </div>
